...
function MusicTestmonialCards() {
  return (
    <div className="section-shell h-auto sm:h-[40rem] rounded-md flex flex-col antialiased bg-white dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden py-8 sm:py-0">
      <div
        className={cn(
          "absolute inset-0",
