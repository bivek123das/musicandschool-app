    ...
    <div className="p-12 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text4xl">Enhance Your Musical Journey</p>
        </div>
        <div className="mt-10">
        <HoverEffect items={musicSchoolWebinars.map(webinar => ({
            title: webinar.title,
        ...
        <div className="mt-10 text-center">
            <Link className="px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-100 transition duration-200" href={"/webinar"}>View All Webinars</Link>
        </div>
      </div>
    </div>
  )
